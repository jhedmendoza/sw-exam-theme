<section id="company-vision" class="w-full md:pl-28">
    <div class="md:pr-28">
        <div class="pb-10 md:pb-0">
            <h1 style="font-size: 7rem;" class="inline-block w-full text-2xl font-medium uppercase text-white sm:text-4xl md:space-y-2 md:text-6xl ">
            ...
            <div class="flex">
                <div class="flex-end pt-6 md:pt-14 w-full">
                    <a class="text-white" href="#services-section">HOW CAN WE HELP</a>
                </div>
            </div>
        </div>
    </div>
